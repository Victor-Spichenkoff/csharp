...
public class Salary: BaseAccount
{
    public Salary(int id, string holder, double balance, double specialCheck) : base(id, AccountType.Savings, holder, balance, specialCheck) {}
